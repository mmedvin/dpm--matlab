classdef AcosBtWD < Tools.Common.FunctionWithDerivatives
    ...
    methods        
        ...
        function varargout = Derivatives(obj,t)
            ...
            if nout > 0, varargout(1)={           obj.a*cos(obj.b*t)  };  end %u
            if nout > 1, varargout(2)={-(obj.b  )*obj.a*sin(obj.b*t)  };  end %ut
