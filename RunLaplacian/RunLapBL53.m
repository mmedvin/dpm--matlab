...
% 5.3  bealy-layton
    ...
    Order=2;
    if Order==2 , ExpansionType=35; Stencil=5; else ExpansionType=35; Stencil=9; end
...
for	   LinearSolverType = 0
	...
	if 1
        ...
        if 1
            ...
            ICun =  (cosxcosy.*xn0 - sinxsiny.*yn0);
   ...
   %------------------------------------------------------------------
    ...
    %Extexact(ExtPrb.Scatterer.Nm) = 0;% ExtExact(FocalDistance,ExtPrb.Scatterer.Eta(ExtPrb.Scatterer.Nm),ExtPrb.Scatterer.Phi(ExtPrb.Scatterer.Nm));
