...
for	   LinearSolverType = 0
    ...
    fprintf('Problem BL53, NBss0=%d, NBss1=%d, LinearSolverType = %d, Order=%d \n', Basis.NBss0, Basis.NBss1, LinearSolverType,Order);
	...
	for n=1:4 %run different grids
        ...
        if Order==4
            ...
            DiffOp = @Tools.DifferentialOps.LaplacianOpBCinMat4OrdrConst;%LaplacianOpBCinMat4OrdrConst; ;
        elseif Order==2
        ...
        ExtPrb =  Solvers.ExteriorHomoLaplacianSolver(struct( ...
                  'Basis'             ,Basis, ...
                  'Grid'              , Grid, ...
                  'CoeffsHandle'      , CoeffsHandle, ...
                  'CoeffsParams'      , CoeffsParams, ...
