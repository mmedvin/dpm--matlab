...
for	   LinearSolverType = 0
	...
	for n=1:5 %run different grids
		...
		IntPrb = Solvers.InteriorLaplacianSolver(struct(...
                 'Basis'             , Basis, ...
                 'Grid'              , GridInt, ...
                 'CoeffsHandle'      , @Tools.Coeffs.LaplaceCoeffsEllps1, ...
                 'CoeffsParams'      , struct('ca',2,'da',1,'ea',3,'WithB',1,'cb',4,'db',3,'eb',2,'sigma',0), ...
...
%        Boundaries.Phi           = imag(BeZ);
        ...
        ExtPrb =  Solvers.ExteriorLaplacianSolver( struct(...
                  'Basis'             , Basis, ...
                  'Grid'              , GridExt, ...
                  'CoeffsHandle'      , ExteriorCoeffsHandle, ...
                  'CoeffsParams'      , ExteriorCoeffsParams, ...
                  'ScattererHandle'   , ScattererHandle, ...
                  'ScattererParams'   , ScattererParams, ...
                  'CollectRhs'        , CollectRhs, ...
                  'DiffOp'            , DiffOp, ... 
