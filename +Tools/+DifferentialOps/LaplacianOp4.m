classdef LaplacianOp4<Tools.DifferentialOps.SuperLaplacianOp
    %LAPLACIANOP4 Summary of this class goes here
    ...
    methods
        function obj = LaplacianOp4(ParamsStruct)
...
%            obj.LaplacianA();
     ...
     methods (Access=protected)
         function LaplacianA(obj)%(x,y,k)
             ...
             b=zeros(size(diag(a)));%sparse(0*(1./(2*diag(a))));
             ...
             function [Ic,Ir,Ym1,Yp1] = InitialDerivationMatrixA()%(k,dx,dy,rows,cols)
                 ...
                 obj.k =zeros( obj.Grid.Nx+2, obj.Grid.Ny+2);% obj.Coeffs.Sigma;
