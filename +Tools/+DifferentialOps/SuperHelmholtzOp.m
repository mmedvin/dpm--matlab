classdef SuperHelmholtzOp<Tools.DifferentialOps.SuperDiffOp
    ...
    methods (Access=public)
        ...
        function obj = SuperHelmholtzOp(ParamsStruct)
            ...
            if nargin>0
                ...
                WN = ParamsStruct.CoeffsHandle(GridK,ParamsStruct.CoeffsParams);
                obj.k = WN.k;
        ...
        function u = Solve(obj,Rhs)
            u=obj.Q*(obj.U\(obj.L\(obj.P*(obj.R\Rhs))));
        end
