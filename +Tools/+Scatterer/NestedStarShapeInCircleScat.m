classdef NestedStarShapeInCircleScat < Tools.Scatterer.NestedScatterer
    ...
    methods
        function obj =  NestedStarShapeInCircleScat(Grid,Params)
            
            Arguments.InteriorScatterer  = @Tools.Scatterer.StarShapedScatterer;
            Arguments.ExteriorScatterer  = @Tools.Scatterer.PolarScatterer;
            Arguments.IntScatParams      = Params.StarShapedParams;
            ...
            obj.TheScatterer = struct('r', union(...
                                                  obj.InteriorScatterer.TheScatterer.r , ...
