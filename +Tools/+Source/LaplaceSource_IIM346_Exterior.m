classdef LaplaceSource_IIM346_Exterior < Tools.Source.LaplaceSource_IIM346_Interior %Tools.Source.SuperSource
...
%         end
        ...
        function obj = LaplaceSource_IIM346_Exterior(Scatterer, CoeffsClsrHndl,CoeffsParams,ExParams)
            obj = obj@Tools.Source.LaplaceSource_IIM346_Interior(Scatterer, CoeffsClsrHndl,CoeffsParams,ExParams);
