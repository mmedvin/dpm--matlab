classdef LaplaceSource01_Exterior < Tools.Source.LaplaceSource01_Interior
...
%         end
        ...
        function obj = LaplaceSource01_Exterior(Scatterer, CoeffsClsrHndl,CoeffsParams,ExParams)
            obj = obj@Tools.Source.LaplaceSource01_Interior(Scatterer, CoeffsClsrHndl,CoeffsParams,ExParams);
			
            obj.IsInterior = false;
